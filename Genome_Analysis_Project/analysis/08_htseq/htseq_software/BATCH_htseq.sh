...
#filepaths
gff_path="/domus/h1/mial5254/Genome-Analysis/Genome_Analysis_Project/analysis/05_prokka/assemble_29/"
bam_path="/domus/h1/mial5254/Genome-Analysis/Genome_Analysis_Project/analysis/07_bwa/bwa_results_29_37/"
out_path="/domus/h1/mial5254/Genome-Analysis/Genome_Analysis_Project/analysis/08_htseq/htseq_results"
...
for bin in {1..27}
do
    gff_dir="SRR29_final.contigs_bin.${bin}"
    ...
    bam_file="${bam_path}/map_SRR4342137_final.contigs_bin.${bin}.bam"
